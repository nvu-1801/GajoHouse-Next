...
export const rooms: Room[] = [
  {
    ...
    gallerySub: [
      { src: '/images/ga-an/ga-an-nang-ban-mai.jpg', label: 'NẮNG BAN MAI' },
  ...
  },
  {
    ...
    galleryTop: {
      src: '/images/ga-mo/IMG_2883.png',
      label: 'SOFA THƯ GIÃN & ĐÈN CÁ BAY',
      objectPosition: 'center 65%',
    },
    gallerySub: [
      { src: '/images/ga-mo/ga-mo-goc-lam-viec.png', label: 'BÀN TIỆC KỶ NIỆM LÃNG MẠN' },
      { src: '/images/ga-mo/ga-mo-tien-nghi.png', label: 'BÁNH KỶ NIỆM & HOA TƯƠI' },
    ],
    specs: [
  ...
  },
  {
    ...
    galleryTop: { src: '/images/ga-gio/IMG_6026.jpg', label: 'TOÀN CẢNH KHÔNG GIAN' },
    gallerySub: [
      { src: '/images/ga-gio/IMG_6031.jpg', label: 'GÓC CHỮA LÀNH' },
  ...
  },
  {
    ...
    gallerySub: [
      { src: '/images/ga-may/IMG_6003.jpg', label: 'PHÒNG TẮM GIẾNG TRỜI' },
  ...
  },
  {
    ...
    gallerySub: [
      { src: '/images/ga-nang/IMG_3276.jpg', label: 'CỬA SỔ TRĂNG RẰM' },
  ...
  },
  {
    ...
    gallerySub: [
      { src: '/images/ga-tron/IMG_6005.jpg', label: 'CỬA GỖ & HIÊN XANH' },
  ...
  },
  {
    ...
    galleryTop: { src: '/images/ga-lac/IMG_toancanh.jpg', label: 'TOÀN CẢNH PHÒNG' },
    gallerySub: [
      { src: '/images/ga-lac/IMG_6019.jpg', label: 'GÓC TRÀ & TỦ MÂY' },
      { src: '/images/ga-lac/IMG_6017.jpg', label: 'GÓC THƯ GIÃN' },
    ],
    specs: [
  ...
  },
  {
    ...
    heroImageZoom: 1,
    heroImagePosition: '50% 50%',
    galleryTop: { src: '/images/general/gajo-family-room.jpg', label: 'TOÀN CẢNH PHÒNG GIA ĐÌNH' },
    gallerySub: [
      { src: '/images/ga-dinh/IMG_3092.jpg', label: 'GÓC THƯ THÁI' },
  ...
  },
  {
    ...
    galleryTop: { src: '/images/ga-moc/gallery-top-new.png', label: 'TOÀN CẢNH PHÒNG VIP' },
    gallerySub: [
      { src: '/images/ga-moc/IMG_5955.jpg', label: 'BỒN TẮM THẢO MỘC' },
